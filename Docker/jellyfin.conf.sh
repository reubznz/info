...
DockerRunCommand() {
    docker run -d --name $ContainerName -p 8096:8096 -p 8920:8920 -p 7359:7359/udp -p 1900:1900/udp -e PUID=1000 -e PGID=1000 -e TZ=Pacific/Auckland -e JELLYFIN_PublishedServerUrl=192.168.37.6 -v jellyfin_dat>}
